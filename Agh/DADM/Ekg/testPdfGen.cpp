...
/*********************przyk³adowe wektory*****************************************************************/
	...
	QVector<QwtIntervalSample> hist1(7);
	hist1 << QwtIntervalSample(5,0,1) << QwtIntervalSample(3,1,2) << QwtIntervalSample(1,2,3)<< QwtIntervalSample(4,3,4)<< QwtIntervalSample(6,4,5)<< QwtIntervalSample(5,5,6)<< QwtIntervalSample(3,6,7); 
	QVector<QwtIntervalSample> hist2(14);
	hist2 << QwtIntervalSample(6,35,37) << QwtIntervalSample(10,37,39)<< QwtIntervalSample(14,39, 41)
		<< QwtIntervalSample(2,41, 43)<< QwtIntervalSample(1, 43, 45)<< QwtIntervalSample(2,45, 47)<< QwtIntervalSample(2, 47, 49)
		<< QwtIntervalSample(2, 49, 51)<< QwtIntervalSample(1, 51, 53)<< QwtIntervalSample(2, 53, 55)<< QwtIntervalSample(2, 55, 57)
		<< QwtIntervalSample(2, 57, 59)<< QwtIntervalSample(1, 59, 61)<< QwtIntervalSample(1, 61, 63);
	/****************************************************************************************************/
...
/***********************Histogram1*****************************************************************************/
		...
		MajorPlot mp2;
		HistogramPlot hp1;
		hp1.HistogramPlotInit(hist1, mp2.plotarea);
		hp1.setHistogramPlotArea(mp2,0.0, 7.0, 1.0, 0.0, 6.0, 1.0, "RR [s]","","");
...
/***********************Histogram2*****************************************************************************/
		MajorPlot mp3;
		HistogramPlot hp2;
		hp2.HistogramPlotInit(hist2, mp3.plotarea);
		hp2.setHistogramPlotArea(mp3,35.0, 64.0, 4.0, 0.0, 15.0, 2.0, "HR [beats/min]","","");
/************************Generacja PDF**********************/
		PdfGenerator p("C:\\Users\\Magdalena\\Desktop\\wykres.pdf");
		p.addHeader();
		
		//Test 1
		bool test1 =  p.addPlot(mp.plotarea, true);
		test1 ? std::cout<<"ok\n" : std::cout<<"error\n";
		//Test 2
		bool test2 = p.addSubtitle("HRV Time-Domain Analysis Results");
		//Test 3
		bool test3 = p.addPlot(mp2.plotarea,mp3.plotarea);
		test3 ? std::cout<<"ok\n" : std::cout<<"error\n";
		return a.exec();
}
