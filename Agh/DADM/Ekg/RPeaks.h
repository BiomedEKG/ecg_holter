...
private:
	...
	std::vector<unsigned int> computePT(std::vector<double> signal, unsigned int sampling_frequency, unsigned int size);
	std::vector<unsigned int> computeHilbert(std::vector<double> signal, unsigned int sampling_frequency, unsigned int size); 
};
