...
{
	this->Signal= ;	
	this->Frequency=rkp->getInput()->GetFs;
	
	this->QRSonset= rkp->getWaves()->getQrsOnset(); // zmieniæ nazwe klucza jeœli inna !!!
	this->QRSend=rkp->getWaves()->getQrsEnd();  
	this->Tpeak=rkp->getWaves()->getTPeaks(); 
