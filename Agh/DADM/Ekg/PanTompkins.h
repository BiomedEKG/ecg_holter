...
public:
	...
	std::vector<double> differentation(std::vector<double> data,unsigned int size);
	double root_mean_squere(std::vector<double> data, unsigned int size);
	double find_max(std::vector<double> data);
	double find_cut_level(std::vector<double> data, unsigned int size);
	std::vector<unsigned int> delete_if_zero(std::vector<unsigned int> data);
	std::vector<double> treshold_data(std::vector<double> data, double treshold, unsigned int size);
	std::vector<unsigned int> find_R(std::vector<double> data, unsigned int size);
	std::vector<double> find_local_max(std::vector<double> data, unsigned int size);
