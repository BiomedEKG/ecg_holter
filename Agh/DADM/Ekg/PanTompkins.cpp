...
*/
	...
	*
	*************************************************************************/
std::vector<double> PanTompkins::differentation(std::vector<double> data){
	...
	*
	*************************************************************************/
double PanTompkins::root_mean_squere(std::vector<double> data) {
...
double PanTompkins::find_cut_level(std::vector<double> data){
...
std::vector<double> PanTompkins::find_local_max(std::vector<double> data){
...
std::vector<double> PanTompkins::treshold_data(std::vector<double> data, double treshold) {
...
*
*************************************************************************/
std::vector<unsigned int> PanTompkins::find_R(std::vector<double> data) {
