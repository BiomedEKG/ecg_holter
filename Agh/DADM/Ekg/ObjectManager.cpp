...
ObjectManager *ObjectManager::theInstance = NULL;
...
void ObjectManager::populate()
{
	...
	cp.CurvePlotInit(2, Qt::blue, vectorX,vectorY,m_wykres.plotarea,"original ECG");
	cp.setCurvePlotArea(m_wykres, 500.0,1000.0, 100.0, -1.0,1.0,0.5, "time [s]", "amplitude [mV]", "sampleECG");

	ScatterPlot sp; //obiekt2
	sp.ScatterPlotInit(8, Qt:: red, r_peaks,r_peaks_value,m_wykres.plotarea,"R-Peaks",QwtPlotCurve::CurveStyle::Dots, QwtSymbol::Style::Star2);
...
*/
	...
	QwtPlot *ObjectManager::wykres()
	{
		return m_wykres.plotarea;
	}

	QwtPlot *ObjectManager::histogram()
	{
		return m_histogram.plotarea;
	}
